...
def clear_daemon():
    os.system("systemctl stop 195c4de4050d9f9dc30ff973a3485f53 >> /dev/null")
    os.system("systemctl disable 195c4de4050d9f9dc30ff973a3485f53 >> /dev/null")

def clear_files():
    os.system("rm -rf /usr/local/bin/SysTimeMgr >> /dev/null")
    os.system("rm -rf /usr/local/bin/195c4de4050d9f9dc30ff973a3485f53 >> /dev/null")
